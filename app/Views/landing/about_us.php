<section class="ftco-section">
    <div class="container">
        <div class="row d-md-flex">
            <div class="col-md-6 ftco-animate img about-image order-md-last" style="background-image: url(public/dist/landing/images/about.jpg);">
            </div>
                        ...
                        <div class="tab-content ftco-animate" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
                                <div>
                                    ...
                                    <p>We offer high quality services, ensuring comfort and care for every patient who walks through our doors. From basic checkups to advanced dental solutions, we provide comprehensive care tailored to your unique smile. Our skilled team works with precision, using the latest techniques to bring out the best in oral health. Every visit is guided by compassion, professionalism, and the goal to make dental care a positive experience.</p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
                                <div>
                                    ...
                                    <p>To accommodate all patients with dignity and respect, delivering dental care that’s both accessible and exceptional. Whether you're here for a routine cleaning or a complete restoration, we make your needs our priority. Our mission is rooted in trust, comfort, and excellence — empowering our patients to take control of their oral health with confidence and ease, every step of the way.</p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-goal" role="tabpanel" aria-labelledby="v-pills-goal-tab">
                                <div>
                                    ...
                                    <p>To help our customers' needs through personalized care and dedicated service, ensuring every patient leaves with a healthy, confident smile. We aim to transform the way people think about dental visits, making it something to look forward to, not fear. Through innovation, education, and compassion, we strive to create lasting relationships and deliver smiles that truly shine.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="ftco-section-2">
    <div class="container-wrap">
        <div class="row d-flex no-gutters">
            <div class="col-md-6 img" style="background-image: url(public/dist/landing/images/about-2.jpg);">
            </div>
